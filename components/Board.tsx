...
function Board() {
  ...
  const handleOnDragEnd = (result: DropResult) => {
    const { destination, source, type } = result; // Desde donde sale el elemento, hacia dónde va y qué elemento es

    if (!destination) return; // Chequea que no se arrastren cosas afuera de Board
    ...
    // Esto es necesario porque los indices están guardados como numeros en vez de id's usando la libreria de react dnd
